insert into clientes(nombre, paterno, materno, tipo_documento, documento_identidad, fecha_nacimiento, genero) values
('Vincenty', 'Funes', 'Cesar', 1, '12345678', '1990-01-01', 'Masculino'),
('Vincenty', 'Funes', 'Nilton', 1, '87654321', '1992-01-01', 'Masculino');

insert into cuentas(cliente_id,tipo_producto,numero_cuenta,moneda,monto,fecha_creacion,sucursal) values
